...
public class MemberJoinController {
	...
	public String step1(@ModelAttribute("member") @Validated(value = {Step3.class}) MemberVO member,BindingResult error, SessionStatus sessionStatus) {
		if(error.hasErrors()) {
			return "join/step1";
		return "join/step1";
		}
	...
	public String cancel(@ModelAttribute("member") MemberVO member, sess) {
