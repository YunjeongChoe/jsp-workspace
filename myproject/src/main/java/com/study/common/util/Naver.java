...
public class Naver {
		...
		public void send_msg(String tel, String rand) {
	        ...
	        String accessKey = "BzHTqDBN8fi2dkvFu3fr";                     						// 개인 인증키
	        String secretKey = "0N9F18CWpIwZ5u68VcKvFR1l4tDZFCsNUKbQTVUo";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
	        String serviceId = "ncp:sms:kr:290951948633:sms";        									// 프로젝트에 할당된 SMS 서비스 ID
