		...
		<nav class="text-center">
			<ul class="pagination">
				...
				<c:if test="${searchVO.curPage > searchVO.pageSize  }">
					<li><a href="freeList.wow?curPage=${searchVO.firstPage-1 }" data-page=""><span aria-hidden="true">&lt;</span></a></li>
				</c:if>
				...
				<c:if test="${searchVO.lastPage != searchVO.totalPageCount }">
					<li><a href="freeList.wow?curPage=${searchVO.lastPage+1 }" data-page=""><span aria-hidden="true">&gt;</span></a></li>
				</c:if>

				<!-- 마지막 페이지 -->
				<li><a href="freeList.wow?curPage=${searchVO.totalPageCount }" data-page=""><span aria-hidden="true">&raquo;</span></a></li>
			</ul>
		</nav>
		<!-- END : 페이지네이션  -->
