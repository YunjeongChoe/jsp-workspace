      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<%=request.getContextPath() %>/about/aboutHome.wow>"></a>About</li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
        		<li><a href="${pageContext.request.contextPath}/free/freeList.wow>"></a>자유게시판</li>
                
                <li><a href="#">자료실</a></li>
                <li><a href="#">공지사항</a></li>
                 <li><a href="<%=request.getContextPath() %>/member/memberList.wow>"></a>회원목록</li>
